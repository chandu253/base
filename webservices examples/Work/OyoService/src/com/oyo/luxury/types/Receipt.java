 ...
 *         &lt;element name="estimated-amount" type="{http://www.w3.org/2001/XMLSchema}float"/>
...
@XmlType(name = "", propOrder = { "message", "estimatedAmount", "status" })
@XmlRootElement(name = "receipt")
public class Receipt {

	@XmlElement(required = true)
	protected String message;
	@XmlElement(name = "estimated-amount")
	 ...
	 * 
	 */
	public void setEstimatedAmount(float value) {
